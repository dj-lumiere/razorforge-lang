...
public partial class SemanticVerifier
{
    ...
    ///
    /// <para>Runs BEFORE reachability (start of <c>RunPhase8Instantiation</c>): folding here means RRP walks
    ...
    private void FoldReflectionMembers(List<Declaration> members)
    {
